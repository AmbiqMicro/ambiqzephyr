...
Ambiq Apollo510 Blue EB
##################

Apollo510 Blue EB is a board by Ambiq featuring their ultra-low power Apollo510 SoC.

.. image:: ./apollo510-soc-engineering-board.jpg
   :align: center
   :alt: Apollo510 Blue EB
...
For more information about the Apollo510 SoC and Apollo510 Blue EB board:

- `Apollo510 Website`_
- `Apollo510 Datasheet`_
- `Apollo510 Blue EB Website`_

Supported Features
==================

The Apollo510 Blue EB board configuration supports the following hardware features:
...
``boards/arm/apollo510_Blue EB/apollo510_Blue EB_defconfig``.
