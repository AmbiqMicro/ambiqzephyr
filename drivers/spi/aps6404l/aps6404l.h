...
//*****************************************************************************
//
//! @name APS6404L Clock Frequencies
//
//*****************************************************************************
...
//! @name
//!
//! @brief According to APS6404L tCEM restriction,
//!          these are the maximum bytes for each speed
//
//*****************************************************************************
...
extern int aps6404l_write(const struct device *dev,
							uint8_t *pui8TxBuffer,
							uint32_t ui32WriteAddress,
							uint32_t ui32NumBytes);

extern int aps6404l_read(const struct device *dev,
