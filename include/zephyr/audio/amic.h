 ...
 *
 * @defgroup audio_amic_interface Digital Microphone Interface
 * @since 1.13
 * @version 0.1.0
 ...
 */
static inline uint32_t amic_build_channel_map(uint8_t channel, uint8_t pdm,
		enum pdm_lr lr)
{
 ...
 */
static inline void amic_parse_channel_map(uint32_t channel_map_lo,
 ...
 */
static inline uint32_t amic_build_clk_skew_map(uint8_t pdm, uint8_t skew)
{
