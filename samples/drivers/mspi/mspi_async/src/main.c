...
struct mspi_xfer_packet packet1[] = {
	{
		.eDirection         = MSPI_TX,
		.ui16DeviceInstr    = DEVICE_MEM_WRITE_INSTR,
		.ui32DeviceAddr     = 0,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)memc_write_buffer,
	...
	},
	{
		...
		.ui32DeviceAddr     = 256,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)(memc_write_buffer + 256),
		.eCBMask            = MSPI_BUS_NO_CB,
	},
	{
		.eDirection         = MSPI_TX,
		...
		.ui32DeviceAddr     = 512,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)(memc_write_buffer + 512),
		.eCBMask            = MSPI_BUS_NO_CB,
	},
	{
		.eDirection         = MSPI_TX,
		...
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)(memc_write_buffer + 512 + 256),
...
struct mspi_xfer_packet packet2[] = {
	{
		.eDirection         = MSPI_RX,
		.ui16DeviceInstr    = DEVICE_MEM_READ_INSTR,
		.ui32DeviceAddr     = 0,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)memc_read_buffer,
		.eCBMask            = MSPI_BUS_NO_CB,
	},
	{
		.eDirection         = MSPI_RX,
		...
		.ui32DeviceAddr     = 256,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)(memc_read_buffer + 256),
		.eCBMask            = MSPI_BUS_NO_CB,
	},
	{
		.eDirection         = MSPI_RX,
		...
		.ui32DeviceAddr     = 512,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)(memc_read_buffer + 512),
		.eCBMask            = MSPI_BUS_NO_CB,
	},
	{
		.eDirection         = MSPI_RX,
		...
		.ui32DeviceAddr     = 512 + 256,
		.ui32NumBytes       = 256,
		.pui32Buffer        = (uint32_t *)(memc_read_buffer + 512 + 256),
		.eCBMask            = MSPI_BUS_XFER_COMPLETE_CB,
	},
};
...
struct mspi_xfer xfer1 = {
	...
	.ui16AddrLength             = 3,
	.ui8Priority                = 1,
	.pPacket                    = (struct mspi_xfer_packet *)&packet1,
	.ui32NumPacket              = sizeof(packet1) / sizeof(struct mspi_xfer_packet),
};
...
struct mspi_xfer xfer2 = {
	...
	.ui16AddrLength             = 3,
	.ui8Priority                = 1,
	.pPacket                    = (struct mspi_xfer_packet *)&packet2,
	.ui32NumPacket              = sizeof(packet2) / sizeof(struct mspi_xfer_packet),
};
...
int main(void)
{
	...
	write_ctx.total_packets = xfer1.ui32NumPacket;
	write_ctx.status        = ~0;
	...
	read_ctx.total_packets  = xfer2.ui32NumPacket;
	read_ctx.status         = ~0;
