...
#define PREROLL_BUFFER_MS       900 // with Preroll
#else
#define PREROLL_BUFFER_MS       0
#endif

#if configUSE_THF_LPSD
#define LPSD_BUFFER_MS          270  // with LPSD + Preroll
#else
#define LPSD_BUFFER_MS          0
#endif

#define THF_MINIMUM_BUFFER_MS   180 // no LPSD, no Preroll

#define AUDIO_BUFFER_MS (PREROLL_BUFFER_MS + LPSD_BUFFER_MS + THF_MINIMUM_BUFFER_MS)
